...
void Map::UpdateMinionsCollisions() {
    ...
    for (int i = 0; i < iMinionListSize; i++) {
        for (unsigned int j = 0; j < lMinion[i].size(); j++) {
            if (!lMinion[i][j]->collisionOnlyWithPlayer /*&& lMinion[i][j]->minionSpawned*/ &&
                lMinion[i][j]->deadTime < 0) {
                // ----- WITH MINIONS IN SAME LIST
                for (unsigned int k = j + 1; k < lMinion[i].size(); k++) {
                    if (!lMinion[i][k]->collisionOnlyWithPlayer /*&& lMinion[i][k]->minionSpawned*/ &&
                        lMinion[i][k]->deadTime < 0) {
                        if (lMinion[i][j]->getXPos() < lMinion[i][k]->getXPos()) {
                            if (lMinion[i][j]->getXPos() + lMinion[i][j]->iHitBoxX >= lMinion[i][k]->getXPos() &&
                                lMinion[i][j]->getXPos() + lMinion[i][j]->iHitBoxX <=
                                lMinion[i][k]->getXPos() + lMinion[i][k]->iHitBoxX &&
                                ((lMinion[i][j]->getYPos() <= lMinion[i][k]->getYPos() + lMinion[i][k]->iHitBoxY &&
                                  lMinion[i][j]->getYPos() + lMinion[i][j]->iHitBoxY >=
                                  lMinion[i][k]->getYPos() + lMinion[i][k]->iHitBoxY) ||
                                 (lMinion[i][k]->getYPos() <= lMinion[i][j]->getYPos() + lMinion[i][j]->iHitBoxY &&
                                  lMinion[i][k]->getYPos() + lMinion[i][k]->iHitBoxY >=
                                  lMinion[i][j]->getYPos() + lMinion[i][j]->iHitBoxY))) {
                                if (lMinion[i][j]->killOtherUnits && lMinion[i][j]->moveSpeed > 0 &&
                                    lMinion[i][k]->minionSpawned) {
                                    lMinion[i][k]->setMinionState(-2);
                                    lMinion[i][j]->collisionWithAnotherUnit();
                                }

                                if (lMinion[i][k]->killOtherUnits && lMinion[i][k]->moveSpeed > 0 &&
                            ...
                            if (lMinion[i][k]->getXPos() + lMinion[i][k]->iHitBoxX >= lMinion[i][j]->getXPos() &&
                                lMinion[i][k]->getXPos() + lMinion[i][k]->iHitBoxX <=
                                lMinion[i][j]->getXPos() + lMinion[i][j]->iHitBoxX &&
                                ((lMinion[i][j]->getYPos() <= lMinion[i][k]->getYPos() + lMinion[i][k]->iHitBoxY &&
                                  lMinion[i][j]->getYPos() + lMinion[i][j]->iHitBoxY >=
                ...
                if (i + 1 < iMinionListSize) {
                    for (unsigned int k = 0; k < lMinion[i + 1].size(); k++) {
                        if (!lMinion[i + 1][k]->collisionOnlyWithPlayer /*&& lMinion[i + 1][k]->minionSpawned*/ &&
                            ...
                            if (lMinion[i][j]->getXPos() < lMinion[i + 1][k]->getXPos()) {
                                if (lMinion[i][j]->getXPos() + lMinion[i][j]->iHitBoxX >=
                                    ...
                                    lMinion[i][j]->getXPos() + lMinion[i][j]->iHitBoxX <=
                                    lMinion[i + 1][k]->getXPos() + lMinion[i + 1][k]->iHitBoxX &&
                                    ((lMinion[i][j]->getYPos() <=
                                      lMinion[i + 1][k]->getYPos() + lMinion[i + 1][k]->iHitBoxY &&
                                      lMinion[i][j]->getYPos() + lMinion[i][j]->iHitBoxY >=
                                      lMinion[i + 1][k]->getYPos() + lMinion[i + 1][k]->iHitBoxY) ||
                                    ...
                                    if (lMinion[i + 1][k]->killOtherUnits && lMinion[i + 1][k]->moveSpeed > 0 &&
                                        lMinion[i][j]->minionSpawned) {
                                        lMinion[i][j]->setMinionState(-2);
                                ...
                                if (lMinion[i + 1][k]->getXPos() + lMinion[i + 1][k]->iHitBoxX >=
                                    lMinion[i][j]->getXPos() &&
                                    lMinion[i + 1][k]->getXPos() + lMinion[i + 1][k]->iHitBoxX <
                                    lMinion[i][j]->getXPos() + lMinion[i][j]->iHitBoxX && ((lMinion[i][j]->getYPos() <=
                                                                                            lMinion[i +
                                                                                                    1][k]->getYPos() +
                                                                                            lMinion[i +
                                                                                                    1][k]->iHitBoxY &&
    ...
    if (!inEvent && !oPlayer->getInLevelAnimation()) {
        ...
        for (int i = getListID(-(int) fXPos + oPlayer->getXPos()) -
                     (getListID(-(int) fXPos + oPlayer->getXPos()) > 0 ? 1 : 0), iSize = i + 2; i < iSize; i++) {
            for (unsigned int j = 0, jSize = lMinion[i].size(); j < jSize; j++) {
                if (lMinion[i][j]->deadTime < 0) {
                    if ((oPlayer->getXPos() - fXPos >= lMinion[i][j]->getXPos() &&
                         oPlayer->getXPos() - fXPos <= lMinion[i][j]->getXPos() + lMinion[i][j]->iHitBoxX) ||
                        (oPlayer->getXPos() - fXPos + oPlayer->getHitBoxX() >= lMinion[i][j]->getXPos() &&
                         oPlayer->getXPos() - fXPos + oPlayer->getHitBoxX() <=
                         lMinion[i][j]->getXPos() + lMinion[i][j]->iHitBoxX)) {
                        if (lMinion[i][j]->getYPos() - 2 <= oPlayer->getYPos() + oPlayer->getHitBoxY() &&
                            lMinion[i][j]->getYPos() + 16 >= oPlayer->getYPos() + oPlayer->getHitBoxY()) {
                            lMinion[i][j]->collisionWithPlayer(true);
                        } else if ((lMinion[i][j]->getYPos() <= oPlayer->getYPos() + oPlayer->getHitBoxY() &&
                                    lMinion[i][j]->getYPos() + lMinion[i][j]->iHitBoxY >=
                                    oPlayer->getYPos() + oPlayer->getHitBoxY()) ||
                                   (lMinion[i][j]->getYPos() <= oPlayer->getYPos() &&
                                    lMinion[i][j]->getYPos() + lMinion[i][j]->iHitBoxY >= oPlayer->getYPos())) {
...
void Map::Draw(SDL_Renderer *rR) {
    ...
    for (unsigned int i = 0; i < vLevelText.size(); i++) {
        CCFG::getText()->Draw(rR, vLevelText[i]->getText(), vLevelText[i]->getXPos() + (int) fXPos,
    ...
    for (int i = getStartBlock(), iEnd = getEndBlock(); i < iEnd && i < iMapWidth; i++) {
        for (int j = iMapHeight - 1; j >= 0; j--) {
            if (lMap[i][j]->getBlockID() != 0) {
                vBlock[lMap[i][j]->getBlockID()]->Draw(rR, 32 * i + (int) fXPos,
...
void Map::DrawLines(SDL_Renderer *rR) {
    ...
    for (int i = 0; i < CCFG::GAME_WIDTH / 32 + 1; i++) {
        for (int j = 0; j < CCFG::GAME_HEIGHT / 32; j++) {
            CCFG::getText()->Draw(rR, std::to_string(i + (-((int) fXPos + (-(int) fXPos) % 32)) / 32),
                                  32 * i + 16 - (-(int) fXPos) % 32 - CCFG::getText()->getTextWidth(
                                          std::to_string(i + (-((int) fXPos + (-(int) fXPos) % 32)) / 32), 8) / 2,
                                  CCFG::GAME_HEIGHT - 9 - 32 * j, 8);
            CCFG::getText()->Draw(rR, std::to_string(j), 32 * i + 16 - (-(int) fXPos) % 32 -
                                                         CCFG::getText()->getTextWidth(std::to_string(j), 8) / 2 + 1,
                                  CCFG::GAME_HEIGHT - 32 * j, 8);
        }
    }
...
Vector2 *Map::getBlockID(int nX, int nY) {
    return new Vector2((int) (nX < 0 ? 0 : nX) / 32,
                       (int) (nY > CCFG::GAME_HEIGHT - 16 ? 0 : (CCFG::GAME_HEIGHT - 16 - nY + 32) / 32));
}
...
void Map::checkCollisionOnTopOfTheBlock(int nX, int nY) {
    ...
    for (int i = (nX - nX % 5) / 5, iEnd = i + 3; i < iEnd && i < iMinionListSize; i++) {
        for (unsigned int j = 0; j < lMinion[i].size(); j++) {
            if (!lMinion[i][j]->collisionOnlyWithPlayer && lMinion[i][j]->getMinionState() >= 0 &&
                ((lMinion[i][j]->getXPos() >= nX * 32 && lMinion[i][j]->getXPos() <= nX * 32 + 32) ||
                 (lMinion[i][j]->getXPos() + lMinion[i][j]->iHitBoxX >= nX * 32 &&
                  lMinion[i][j]->getXPos() + lMinion[i][j]->iHitBoxX <= nX * 32 + 32))) {
                if (lMinion[i][j]->getYPos() + lMinion[i][j]->iHitBoxY >= CCFG::GAME_HEIGHT - 24 - nY * 32 &&
                    lMinion[i][j]->getYPos() + lMinion[i][j]->iHitBoxY <= CCFG::GAME_HEIGHT - nY * 32 + 16) {
...
void Map::addGoombas(int iX, int iY, bool moveDirection) {
    lMinion[getListID(iX)].push_back(
            new Goombas(iX, iY, iLevelType == 0 || iLevelType == 4 ? 0 : iLevelType == 1 ? 8 : 10, moveDirection));
}
...
void Map::loadPipeEventsLVL_1_1() {
    ...
    lPipe.push_back(
            new Pipe(1, 253, 3, 253, 2, 163 * 32, CCFG::GAME_HEIGHT - 16 - 3 * 32, currentLevelID, 0, true, 350, 1,
                     false));
}
...
void Map::loadPipeEventsLVL_1_2() {
    ...
    lPipe.push_back(
            new Pipe(1, 253, 3, 253, 2, 115 * 32, CCFG::GAME_HEIGHT - 16 - 3 * 32, currentLevelID, 1, true, 350, 1,
                     false));

    lPipe.push_back(
            new Pipe(1, 166, 6, 166, 5, 284 * 32, CCFG::GAME_HEIGHT - 16 - 3 * 32, currentLevelID, 0, true, 350, 1,
                     false));
...
void Map::loadPipeEventsLVL_2_1() {
    ...
    lPipe.push_back(
            new Pipe(1, 243, 3, 243, 2, 115 * 32, CCFG::GAME_HEIGHT - 16 - 3 * 32, currentLevelID, 0, true, 350, 1,
                     false));
}

void Map::loadPipeEventsLVL_2_2() {
    lPipe.push_back(
            new Pipe(1, 189, 7, 189, 6, 274 * 32, CCFG::GAME_HEIGHT - 16 - 3 * 32, currentLevelID, 0, true, 350, 1,
                     false));
}
...
void Map::loadPipeEventsLVL_3_1() {
    ...
    lPipe.push_back(
            new Pipe(1, 253, 3, 253, 2, 67 * 32, CCFG::GAME_HEIGHT - 16 - 3 * 32, currentLevelID, 4, true, 350, 1,
                     false));
}
...
void Map::loadPipeEventsLVL_4_1() {
    ...
    lPipe.push_back(
            new Pipe(1, 263, 3, 263, 2, 163 * 32, CCFG::GAME_HEIGHT - 16 - 3 * 32, currentLevelID, 0, true, 350, 1,
                     false));
}
...
void Map::loadPipeEventsLVL_4_2() {
    ...
    lPipe.push_back(
            new Pipe(1, 283, 3, 283, 2, 131 * 32, CCFG::GAME_HEIGHT - 16 - 3 * 32, currentLevelID, 1, true, 350, 1,
                     false));

    lPipe.push_back(
            new Pipe(1, 187, 6, 187, 5, 394 * 32, CCFG::GAME_HEIGHT - 16 - 3 * 32, currentLevelID, 0, true, 350, 1,
                     false));
...
void Map::loadPipeEventsLVL_5_1() {
    ...
    lPipe.push_back(
            new Pipe(1, 241, 3, 241, 2, 163 * 32, CCFG::GAME_HEIGHT - 16 - 3 * 32, currentLevelID, 0, true, 350, 1,
                     false));
}
...
void Map::loadPipeEventsLVL_5_2() {
    ...
    lPipe.push_back(
            new Pipe(1, 62, 7, 62, 6, 195 * 32, CCFG::GAME_HEIGHT - 16 - 3 * 32, currentLevelID, 0, true, 350, 1,
                     false));
}
...
void Map::loadPipeEventsLVL_6_2() {
    ...
    lPipe.push_back(
            new Pipe(1, 62, 7, 62, 6, 200 * 32, CCFG::GAME_HEIGHT - 16 - 3 * 32, currentLevelID, 4, true, 350, 1,
                     false));

    lPipe.push_back(new Pipe(0, 104, 5, 105, 5, 332 * 32, 32, currentLevelID, 1, false, 350, 1, false));

    lPipe.push_back(
            new Pipe(1, 343, 3, 343, 2, 120 * 32, CCFG::GAME_HEIGHT - 16 - 3 * 32, currentLevelID, 4, true, 350, 1,
                     false));

    lPipe.push_back(new Pipe(0, 238, 4, 239, 4, 362 * 32, 32, currentLevelID, 1, false, 350, 1, false));

    lPipe.push_back(
            new Pipe(1, 373, 3, 373, 2, 264 * 32, CCFG::GAME_HEIGHT - 16 - 3 * 32, currentLevelID, 4, true, 350, 1,
                     false));
}
...
void Map::loadPipeEventsLVL_7_1() {
    ...
    lPipe.push_back(
            new Pipe(1, 223, 3, 223, 2, 115 * 32, CCFG::GAME_HEIGHT - 16 - 3 * 32, currentLevelID, 0, true, 350, 1,
                     false));
}
...
void Map::loadPipeEventsLVL_8_1() {
    ...
    lPipe.push_back(
            new Pipe(1, 423, 3, 423, 2, 115 * 32, CCFG::GAME_HEIGHT - 16 - 3 * 32, currentLevelID, 0, true, 350, 1,
                     false));
}
...
void Map::loadPipeEventsLVL_8_4() {
    lPipe.push_back(
            new Pipe(2, 81, 6, 82, 6, 126 * 32, CCFG::GAME_HEIGHT - 16 - 3 * 32, currentLevelID, 3, true, 250, 1,
                     false));

    lPipe.push_back(
            new Pipe(2, 163, 8, 164, 8, 215 * 32, CCFG::GAME_HEIGHT - 16 - 3 * 32, currentLevelID, 3, true, 250, 1,
                     false));

    lPipe.push_back(
            new Pipe(2, 248, 6, 249, 6, 393 * 32, CCFG::GAME_HEIGHT - 16 - 3 * 32, currentLevelID, 2, true, 250, 1,
                     true));
    lPipe.push_back(
            new Pipe(1, 458, 7, 458, 6, 302 * 32, CCFG::GAME_HEIGHT - 16 - 3 * 32, currentLevelID, 3, true, 350, 1,
                     false));

    lPipe.push_back(new Pipe(2, 51, 4, 52, 4, 19 * 32, CCFG::GAME_HEIGHT - 16 - 3 * 32, currentLevelID, 3, true, 250, 1,
                             false));
    lPipe.push_back(
            new Pipe(2, 143, 3, 144, 3, 19 * 32, CCFG::GAME_HEIGHT - 16 - 3 * 32, currentLevelID, 3, true, 250, 1,
                     false));
    lPipe.push_back(
            new Pipe(2, 232, 7, 232, 7, 19 * 32, CCFG::GAME_HEIGHT - 16 - 3 * 32, currentLevelID, 3, true, 250, 1,
                     false));
    lPipe.push_back(
            new Pipe(2, 309, 3, 310, 3, 19 * 32, CCFG::GAME_HEIGHT - 16 - 3 * 32, currentLevelID, 3, true, 250, 1,
                     false));
}
...
void Map::loadLVL_1_2() {
    ...
    vPlatform.push_back(
            new Platform(6, 0, 139 * 32 + 16, 139 * 32 + 16, -32, CCFG::GAME_HEIGHT + 32, 139 * 32 + 16, 9 * 32 + 16,
                         true));
    vPlatform.push_back(
            new Platform(6, 0, 139 * 32 + 16, 139 * 32 + 16, -32, CCFG::GAME_HEIGHT + 32, 139 * 32 + 16, 1 * 32 + 16,
                         true));

    vPlatform.push_back(
            new Platform(6, 1, 154 * 32 + 16, 154 * 32 + 16, -32, CCFG::GAME_HEIGHT + 32, 154 * 32 + 16, 10 * 32,
                         true));
    vPlatform.push_back(
            new Platform(6, 1, 154 * 32 + 16, 154 * 32 + 16, -32, CCFG::GAME_HEIGHT + 32, 154 * 32 + 16, 2 * 32, true));
...
void Map::loadLVL_1_3() {
    ...
    vPlatform.push_back(
            new Platform(6, 2, 55 * 32, 55 * 32, CCFG::GAME_HEIGHT - 16 - 9 * 32, CCFG::GAME_HEIGHT - 32, 55 * 32,
                         (float) CCFG::GAME_HEIGHT - 32, true));

    vPlatform.push_back(new Platform(6, 3, 83 * 32 - 16, 86 * 32 + 16, CCFG::GAME_HEIGHT - 16 - 6 * 32,
                                     CCFG::GAME_HEIGHT - 16 - 6 * 32, 83 * 32 - 16,
                                     (float) CCFG::GAME_HEIGHT - 16 - 6 * 32, true));

    vPlatform.push_back(new Platform(6, 3, 91 * 32 - 16, 93 * 32 + 16, CCFG::GAME_HEIGHT - 16 - 5 * 32,
                                     CCFG::GAME_HEIGHT - 16 - 5 * 32, 93 * 32 + 16,
                                     (float) CCFG::GAME_HEIGHT - 16 - 5 * 32, false));

    vPlatform.push_back(new Platform(6, 3, 127 * 32 - 16, 131 * 32 + 16, CCFG::GAME_HEIGHT - 16 - 8 * 32,
                                     CCFG::GAME_HEIGHT - 16 - 8 * 32, 127 * 32 - 16,
                                     (float) CCFG::GAME_HEIGHT - 16 - 8 * 32, false));
...
void Map::loadLVL_1_4() {
    ...
    vPlatform.push_back(new Platform(4, 3, 136 * 32 - 16, 138 * 32 + 16, CCFG::GAME_HEIGHT - 16 - 8 * 32,
                                     CCFG::GAME_HEIGHT - 16 - 8 * 32, 136 * 32 - 16,
                                     (float) CCFG::GAME_HEIGHT - 16 - 8 * 32, false));
...
void Map::loadLVL_2_1() {
    ...
    vPlatform.push_back(new Platform(6, 4, 286 * 32 + 16, 335 * 32 + 16, CCFG::GAME_HEIGHT - 16 - 4 * 32,
                                     CCFG::GAME_HEIGHT - 16 - 4 * 32, 286 * 32.0f + 16,
                                     CCFG::GAME_HEIGHT - 16.0f - 4 * 32, true));
...
void Map::loadLVL_2_4() {
    ...
    vPlatform.push_back(
            new Platform(3, 1, 85 * 32 + 24, 85 * 32 + 16, -32, CCFG::GAME_HEIGHT + 32, 85 * 32 + 24, 9 * 32 + 16,
                         true));
    vPlatform.push_back(
            new Platform(3, 1, 85 * 32 + 24, 85 * 32 + 16, -32, CCFG::GAME_HEIGHT + 32, 85 * 32 + 24, 1 * 32 + 16,
                         true));

    vPlatform.push_back(
            new Platform(3, 0, 88 * 32 + 24, 88 * 32 + 16, -32, CCFG::GAME_HEIGHT + 32, 88 * 32 + 24, 10 * 32, true));
    vPlatform.push_back(
            new Platform(3, 0, 88 * 32 + 24, 88 * 32 + 16, -32, CCFG::GAME_HEIGHT + 32, 88 * 32 + 24, 2 * 32, true));
...
void Map::loadLVL_3_1() {
    ...
    vPlatform.push_back(new Platform(6, 4, 286 * 32 + 16, 355 * 32 + 16, CCFG::GAME_HEIGHT - 16 - 4 * 32,
                                     CCFG::GAME_HEIGHT - 16 - 4 * 32, 286 * 32.0f + 16,
                                     CCFG::GAME_HEIGHT - 16.0f - 4 * 32, true));
...
void Map::loadLVL_3_3() {
    ...
    vPlatform.push_back(
            new Platform(6, 6, 81 * 32, 81 * 32, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11 * 32, 81 * 32,
                         (float) CCFG::GAME_HEIGHT - 16 - 8 * 32, true, 1));
    vPlatform.push_back(
            new Platform(6, 6, 88 * 32, 88 * 32, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11 * 32, 88 * 32,
                         (float) CCFG::GAME_HEIGHT - 16 - 6 * 32, true, 0));

    structSeeSaw(137, 12, 5);
    vPlatform.push_back(
            new Platform(6, 6, 136 * 32, 136 * 32, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11 * 32, 136 * 32,
                         (float) CCFG::GAME_HEIGHT - 16 - 9 * 32, true, 3));
    vPlatform.push_back(
            new Platform(6, 6, 140 * 32, 140 * 32, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11 * 32, 140 * 32,
                         (float) CCFG::GAME_HEIGHT - 16 - 6 * 32, true, 2));
    // -- SEESAW

    vPlatform.push_back(new Platform(6, 3, 27 * 32 - 16, 30 * 32 + 16, CCFG::GAME_HEIGHT - 16 - 10 * 32,
                                     CCFG::GAME_HEIGHT - 16 - 10 * 32, 27 * 32 - 16,
                                     (float) CCFG::GAME_HEIGHT - 16 - 10 * 32, false));
    vPlatform.push_back(new Platform(6, 3, 30 * 32 - 16, 33 * 32 + 16, CCFG::GAME_HEIGHT - 16 - 6 * 32,
                                     CCFG::GAME_HEIGHT - 16 - 6 * 32, 33 * 32 + 16,
                                     (float) CCFG::GAME_HEIGHT - 16 - 6 * 32, true));
    vPlatform.push_back(
            new Platform(6, 3, 91 * 32 - 32, 94 * 32, CCFG::GAME_HEIGHT - 16 - 5 * 32, CCFG::GAME_HEIGHT - 16 - 5 * 32,
                         94 * 32, (float) CCFG::GAME_HEIGHT - 16 - 5 * 32, true));
    vPlatform.push_back(
            new Platform(6, 3, 92 * 32, 96 * 32, CCFG::GAME_HEIGHT - 16 - 9 * 32, CCFG::GAME_HEIGHT - 16 - 9 * 32,
                         92 * 32, (float) CCFG::GAME_HEIGHT - 16 - 9 * 32, false));
    vPlatform.push_back(new Platform(6, 3, 100 * 32 - 16, 103 * 32 + 16, CCFG::GAME_HEIGHT - 16 - 3 * 32,
                                     CCFG::GAME_HEIGHT - 16 - 3 * 32, 103 * 32 + 16,
                                     (float) CCFG::GAME_HEIGHT - 16 - 3 * 32, true));
    vPlatform.push_back(new Platform(6, 3, 129 * 32 - 16, 132 * 32 + 16, CCFG::GAME_HEIGHT - 16 - 8 * 32,
                                     CCFG::GAME_HEIGHT - 16 - 8 * 32, 132 * 32 + 16,
                                     (float) CCFG::GAME_HEIGHT - 16 - 8 * 32, true));

    vPlatform.push_back(
            new Platform(6, 5, 60 * 32, 60 * 32, CCFG::GAME_HEIGHT - 16 - 8 * 32, CCFG::GAME_HEIGHT - 16 - 8 * 32,
                         60 * 32, (float) CCFG::GAME_HEIGHT - 16 - 8 * 32, true));
...
void Map::loadLVL_4_2() {
    ...
    vPlatform.push_back(
            new Platform(6, 0, 58 * 32 + 16, 58 * 32 + 16, -32, CCFG::GAME_HEIGHT + 32, 58 * 32 + 16, 9 * 32 + 16,
                         true));
    vPlatform.push_back(
            new Platform(6, 0, 58 * 32 + 16, 58 * 32 + 16, -32, CCFG::GAME_HEIGHT + 32, 58 * 32 + 16, 1 * 32 + 16,
                         true));

    vPlatform.push_back(
            new Platform(6, 0, 114 * 32 + 16, 114 * 32 + 16, -32, CCFG::GAME_HEIGHT + 32, 114 * 32 + 16, 9 * 32 + 16,
                         true));
    vPlatform.push_back(
            new Platform(6, 0, 114 * 32 + 16, 114 * 32 + 16, -32, CCFG::GAME_HEIGHT + 32, 114 * 32 + 16, 1 * 32 + 16,
                         true));
    ...
    vPlatform.push_back(
            new Platform(6, 0, 156 * 32, 156 * 32, -32, CCFG::GAME_HEIGHT + 32, 156 * 32, 9 * 32 + 16, true));
    vPlatform.push_back(
            new Platform(6, 0, 156 * 32, 156 * 32, -32, CCFG::GAME_HEIGHT + 32, 156 * 32, 1 * 32 + 16, true));
...
void Map::loadLVL_4_3() {
    ...
    vPlatform.push_back(
            new Platform(6, 6, 48 * 32, 48 * 32, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11 * 32, 48 * 32,
                         (float) CCFG::GAME_HEIGHT - 16 - 9 * 32, true, 1));
    vPlatform.push_back(
            new Platform(6, 6, 55 * 32, 55 * 32, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11 * 32, 55 * 32,
                         (float) CCFG::GAME_HEIGHT - 16 - 6 * 32, true, 0));

    structSeeSaw(81, 12, 9);
    vPlatform.push_back(
            new Platform(6, 6, 80 * 32, 80 * 32, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11 * 32, 80 * 32,
                         (float) CCFG::GAME_HEIGHT - 16 - 9 * 32, true, 3));
    vPlatform.push_back(
            new Platform(6, 6, 88 * 32, 88 * 32, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11 * 32, 88 * 32,
                         (float) CCFG::GAME_HEIGHT - 16 - 5 * 32, true, 2));

    structSeeSaw(92, 12, 6);
    vPlatform.push_back(
            new Platform(6, 6, 91 * 32, 91 * 32, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11 * 32, 91 * 32,
                         (float) CCFG::GAME_HEIGHT - 16 - 9 * 32, true, 5));
    vPlatform.push_back(
            new Platform(6, 6, 96 * 32, 96 * 32, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11 * 32, 96 * 32,
                         (float) CCFG::GAME_HEIGHT - 16 - 5 * 32, true, 4));

    structSeeSaw(103, 12, 7);
    vPlatform.push_back(
            new Platform(6, 6, 102 * 32, 102 * 32, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11 * 32, 102 * 32,
                         (float) CCFG::GAME_HEIGHT - 16 - 9 * 32, true, 7));
    vPlatform.push_back(
            new Platform(6, 6, 108 * 32, 108 * 32, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11 * 32, 108 * 32,
                         (float) CCFG::GAME_HEIGHT - 16 - 5 * 32, true, 6));
    // -- SEESAW

    vPlatform.push_back(
            new Platform(6, 2, 58 * 32, 58 * 32, CCFG::GAME_HEIGHT - 16 - 10 * 32, CCFG::GAME_HEIGHT - 64, 58 * 32,
                         (float) CCFG::GAME_HEIGHT - 64, true));
    vPlatform.push_back(
            new Platform(6, 2, 62 * 32, 62 * 32, CCFG::GAME_HEIGHT - 12 * 32, CCFG::GAME_HEIGHT - 128, 62 * 32,
                         (float) CCFG::GAME_HEIGHT - 12 * 32, false));
    vPlatform.push_back(
            new Platform(6, 2, 136 * 32, 136 * 32, CCFG::GAME_HEIGHT - 16 - 9 * 32, CCFG::GAME_HEIGHT - 48, 136 * 32,
                         (float) CCFG::GAME_HEIGHT - 6 * 32, false));
...
void Map::loadLVL_5_2() {
    ...
    vPlatform.push_back(
            new Platform(6, 2, 22 * 32, 22 * 32, CCFG::GAME_HEIGHT - 12 * 32, CCFG::GAME_HEIGHT - 16 - 3 * 32,
                         22 * 32 + 16, (float) CCFG::GAME_HEIGHT - 16 - 4 * 32, true));
    vPlatform.push_back(
            new Platform(6, 2, 28 * 32, 28 * 32, CCFG::GAME_HEIGHT - 12 * 32, CCFG::GAME_HEIGHT - 16 - 3 * 32,
                         28 * 32 + 16, (float) CCFG::GAME_HEIGHT - 12 * 32, false));
    ...
    vPlatform.push_back(new Platform(6, 4, 341 * 32 + 16, 390 * 32 + 16, CCFG::GAME_HEIGHT - 16 - 4 * 32,
                                     CCFG::GAME_HEIGHT - 16 - 4 * 32, 341 * 32.0f + 16,
                                     CCFG::GAME_HEIGHT - 16.0f - 4 * 32, true));
}
...
void Map::loadLVL_5_3() {
    ...
    vPlatform.push_back(
            new Platform(4, 2, 55 * 32, 55 * 32, CCFG::GAME_HEIGHT - 16 - 9 * 32, CCFG::GAME_HEIGHT - 32, 55 * 32,
                         (float) CCFG::GAME_HEIGHT - 32, true));

    vPlatform.push_back(new Platform(4, 3, 83 * 32 - 16, 86 * 32 + 16, CCFG::GAME_HEIGHT - 16 - 6 * 32,
                                     CCFG::GAME_HEIGHT - 16 - 6 * 32, 83 * 32 - 16,
                                     (float) CCFG::GAME_HEIGHT - 16 - 6 * 32, true));

    vPlatform.push_back(new Platform(4, 3, 91 * 32 - 16, 93 * 32 + 16, CCFG::GAME_HEIGHT - 16 - 5 * 32,
                                     CCFG::GAME_HEIGHT - 16 - 5 * 32, 93 * 32 + 16,
                                     (float) CCFG::GAME_HEIGHT - 16 - 5 * 32, false));

    vPlatform.push_back(new Platform(4, 3, 127 * 32 - 16, 131 * 32 + 16, CCFG::GAME_HEIGHT - 16 - 8 * 32,
                                     CCFG::GAME_HEIGHT - 16 - 8 * 32, 127 * 32 - 16,
                                     (float) CCFG::GAME_HEIGHT - 16 - 8 * 32, false));
...
void Map::loadLVL_6_2() {
    ...
    vPlatform.push_back(
            new Platform(4, 2, 22 * 32, 22 * 32, CCFG::GAME_HEIGHT - 12 * 32, CCFG::GAME_HEIGHT - 16 - 3 * 32,
                         22 * 32 + 16, (float) CCFG::GAME_HEIGHT - 16 - 4 * 32, true));
    vPlatform.push_back(
            new Platform(4, 2, 28 * 32, 28 * 32, CCFG::GAME_HEIGHT - 12 * 32, CCFG::GAME_HEIGHT - 16 - 3 * 32,
                         28 * 32 + 16, (float) CCFG::GAME_HEIGHT - 12 * 32, false));
    ...
    vPlatform.push_back(new Platform(6, 4, 406 * 32 + 16, 475 * 32 + 16, CCFG::GAME_HEIGHT - 16 - 4 * 32,
                                     CCFG::GAME_HEIGHT - 16 - 4 * 32, 406 * 32.0f + 16,
                                     CCFG::GAME_HEIGHT - 16.0f - 4 * 32, true));
...
void Map::loadLVL_6_3() {
    ...
    vPlatform.push_back(
            new Platform(4, 6, 70 * 32 + 16, 70 * 32 + 16, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11 * 32,
                         70 * 32 + 16, (float) CCFG::GAME_HEIGHT - 16 - 9 * 32, true, 1));
    vPlatform.push_back(
            new Platform(4, 6, 74 * 32 + 16, 74 * 32 + 16, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11 * 32,
                         74 * 32 + 16, (float) CCFG::GAME_HEIGHT - 16 - 5 * 32, true, 0));

    structSeeSaw(79, 12, 4);

    vPlatform.push_back(
            new Platform(4, 6, 78 * 32 + 16, 78 * 32 + 16, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11 * 32,
                         78 * 32 + 16, (float) CCFG::GAME_HEIGHT - 16 - 9 * 32, true, 3));
    vPlatform.push_back(
            new Platform(4, 6, 81 * 32 + 16, 81 * 32 + 16, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11 * 32,
                         81 * 32 + 16, (float) CCFG::GAME_HEIGHT - 16 - 5 * 32, true, 2));

    structSeeSaw(127, 12, 4);

    vPlatform.push_back(
            new Platform(4, 6, 126 * 32 + 16, 126 * 32 + 16, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11 * 32,
                         126 * 32 + 16, (float) CCFG::GAME_HEIGHT - 16 - 9 * 32, true, 5));
    vPlatform.push_back(
            new Platform(4, 6, 129 * 32 + 16, 129 * 32 + 16, CCFG::GAME_HEIGHT - 16, CCFG::GAME_HEIGHT - 16 - 11 * 32,
                         129 * 32 + 16, (float) CCFG::GAME_HEIGHT - 16 - 5 * 32, true, 4));

    // -- SEESAW

    vPlatform.push_back(
            new Platform(4, 2, 28 * 32, 28 * 32, CCFG::GAME_HEIGHT - 11 * 32, CCFG::GAME_HEIGHT - 16 - 2 * 32, 28 * 32,
                         (float) CCFG::GAME_HEIGHT - 12 * 32, false));

    vPlatform.push_back(
            new Platform(4, 3, 39 * 32 + 16, 45 * 32 + 16, CCFG::GAME_HEIGHT - 9 * 32, CCFG::GAME_HEIGHT - 16 - 9 * 32,
                         39 * 32 + 16, (float) CCFG::GAME_HEIGHT - 9 * 32, false));
    vPlatform.push_back(
            new Platform(4, 3, 45 * 32 + 16, 49 * 32 + 16, CCFG::GAME_HEIGHT - 7 * 32, CCFG::GAME_HEIGHT - 16 - 7 * 32,
                         45 * 32 + 16, (float) CCFG::GAME_HEIGHT - 7 * 32, true));
    vPlatform.push_back(
            new Platform(4, 3, 51 * 32, 56 * 32, CCFG::GAME_HEIGHT - 8 * 32, CCFG::GAME_HEIGHT - 16 - 8 * 32,
                         51 * 32 + 16, (float) CCFG::GAME_HEIGHT - 8 * 32, false));

    vPlatform.push_back(
            new Platform(4, 2, 60 * 32, 60 * 32, CCFG::GAME_HEIGHT - 11 * 32, CCFG::GAME_HEIGHT - 16 - 2 * 32, 60 * 32,
                         (float) CCFG::GAME_HEIGHT - 12 * 32, false));
    vPlatform.push_back(new Platform(4, 2, 121 * 32 + 16, 121 * 32 + 16, CCFG::GAME_HEIGHT - 11 * 32,
                                     CCFG::GAME_HEIGHT - 16 - 2 * 32, 121 * 32 + 16,
                                     (float) CCFG::GAME_HEIGHT - 12 * 32, false));

    vPlatform.push_back(
            new Platform(4, 5, 141 * 32, 141 * 32, CCFG::GAME_HEIGHT - 16 - 7 * 32, CCFG::GAME_HEIGHT - 16 - 7 * 32,
                         141 * 32, (float) CCFG::GAME_HEIGHT - 16 - 7 * 32, true));
    vPlatform.push_back(
            new Platform(4, 5, 145 * 32, 145 * 32, CCFG::GAME_HEIGHT - 16 - 8 * 32, CCFG::GAME_HEIGHT - 16 - 8 * 32,
                         145 * 32, (float) CCFG::GAME_HEIGHT - 16 - 8 * 32, true));
    vPlatform.push_back(
            new Platform(4, 5, 149 * 32, 149 * 32, CCFG::GAME_HEIGHT - 16 - 6 * 32, CCFG::GAME_HEIGHT - 16 - 6 * 32,
                         149 * 32, (float) CCFG::GAME_HEIGHT - 16 - 6 * 32, true));
    vPlatform.push_back(
            new Platform(4, 5, 153 * 32, 153 * 32, CCFG::GAME_HEIGHT - 16 - 7 * 32, CCFG::GAME_HEIGHT - 16 - 7 * 32,
                         153 * 32, (float) CCFG::GAME_HEIGHT - 16 - 7 * 32, true));
...
void Map::loadLVL_7_4() {
    ...
    vPlatform.push_back(
            new Platform(4, 5, 18 * 32, 18 * 32, CCFG::GAME_HEIGHT - 16 - 7 * 32, CCFG::GAME_HEIGHT - 16 - 7 * 32,
                         18 * 32, (float) CCFG::GAME_HEIGHT - 16 - 7 * 32, true));
    vPlatform.push_back(
            new Platform(4, 5, 22 * 32, 22 * 32, CCFG::GAME_HEIGHT - 16 - 6 * 32, CCFG::GAME_HEIGHT - 16 - 6 * 32,
                         22 * 32, (float) CCFG::GAME_HEIGHT - 16 - 6 * 32, true));
...
void Map::loadLVL_8_4() {
    ...
    vPlatform.push_back(
            new Platform(4, 3, 68 * 32 - 16, 71 * 32 + 16, CCFG::GAME_HEIGHT - 16 - 32, CCFG::GAME_HEIGHT - 16 - 32,
                         68 * 32 - 16, (float) CCFG::GAME_HEIGHT - 16 - 30, true));
                    ...
                    if (lMap[nX][nY]->getPowerUP()) {
                        if (oPlayer->getPowerLVL() == 0) {
                            lMinion[getListID(32 * nX)].push_back(
                                    new Mushroom(32 * nX, CCFG::GAME_HEIGHT - 16 - 32 * nY, true, nX, nY));
                        } else {
                            lMinion[getListID(32 * nX)].push_back(
                                    new Flower(32 * nX, CCFG::GAME_HEIGHT - 16 - 32 * nY, nX, nY));
                        }
                    } else {
                        lMinion[getListID(32 * nX)].push_back(
                                new Mushroom(32 * nX, CCFG::GAME_HEIGHT - 16 - 32 * nY, false, nX, nY));
                    }
...
void Map::EndUse() {
    ...
    oEvent->vOLDDir.push_back((Event::animationType &&) oEvent->eRIGHTEND);
    oEvent->vOLDLength.push_back(oPlayer->getHitBoxX());

    oEvent->vOLDDir.push_back((Event::animationType &&) oEvent->eENDBOT1);
    oEvent->vOLDLength.push_back((CCFG::GAME_HEIGHT - 16 - 32 * 2) - oPlayer->getYPos() - oPlayer->getHitBoxY() - 2);

    oEvent->vOLDDir.push_back((Event::animationType &&) oEvent->eENDBOT2);
    oEvent->vOLDLength.push_back((CCFG::GAME_HEIGHT - 16 - 32 * 2) - oPlayer->getYPos() - oPlayer->getHitBoxY() - 2);

    oEvent->vOLDDir.push_back((Event::animationType &&) oEvent->eRIGHTEND);
    oEvent->vOLDLength.push_back(oPlayer->getHitBoxX());

    oEvent->vOLDDir.push_back((Event::animationType &&) oEvent->eBOTRIGHTEND);
    ...
    switch (currentLevelID) {
        ...
        case 2: {
            ...
            oEvent->vOLDDir.push_back((Event::animationType &&) oEvent->eRIGHT);
            oEvent->vOLDLength.push_back(32);
    ...
    oEvent->vOLDDir.push_back((Event::animationType &&) oEvent->eENDPOINTS);
    oEvent->vOLDLength.push_back(iMapTime);

    oEvent->vOLDDir.push_back((Event::animationType &&) oEvent->eNOTHING);
    oEvent->vOLDLength.push_back(128);
}
...
void Map::EndBoss() {
    ...
    if (lMap[getBlockIDX((int) (oPlayer->getXPos() + oPlayer->getHitBoxX() / 2 - fXPos))][6]->getBlockID() == 82) {
        oEvent->vOLDDir.push_back((Event::animationType &&) oEvent->eBOT);
        ...
        oEvent->vOLDLength.push_back(
                32 - CCFG::GAME_HEIGHT - 16 - 5 * 32 - (oPlayer->getYPos() + oPlayer->getHitBoxY()));
        addOne = true;
    }

    oEvent->vOLDDir.push_back((Event::animationType &&) oEvent->eBOSSEND1);
    oEvent->vOLDLength.push_back(1);
    oEvent->vOLDDir.push_back((Event::animationType &&) oEvent->eNOTHING);
    oEvent->vOLDLength.push_back(10);

    oEvent->vOLDDir.push_back((Event::animationType &&) oEvent->eBOSSEND2);
    oEvent->vOLDLength.push_back(1);
    oEvent->vOLDDir.push_back((Event::animationType &&) oEvent->eNOTHING);
    oEvent->vOLDLength.push_back(3);

    for (int i = 0; i < 6; i++) {
        oEvent->vOLDDir.push_back((Event::animationType &&) oEvent->eBOSSEND3);
        oEvent->vOLDLength.push_back(2 + i);
        oEvent->vOLDDir.push_back((Event::animationType &&) oEvent->eNOTHING);
        oEvent->vOLDLength.push_back(3);
    }

    oEvent->vOLDDir.push_back((Event::animationType &&) oEvent->eBOSSEND4);
    oEvent->vOLDLength.push_back(1);
    ...
    oEvent->vOLDDir.push_back((Event::animationType &&) oEvent->eBOTRIGHTBOSS);
    oEvent->vOLDLength.push_back(8 * 32);

    switch (currentLevelID) {
        case 31:
            oEvent->vOLDDir.push_back((Event::animationType &&) oEvent->eENDGAMEBOSSTEXT1);
            oEvent->vOLDLength.push_back(
                    getBlockIDX((int) (oPlayer->getXPos() + oPlayer->getHitBoxX() / 2 - fXPos)) * 32 + 7 * 32 +
                    (addOne ? 32 : 0));
            break;
        default:
            oEvent->vOLDDir.push_back((Event::animationType &&) oEvent->eBOSSTEXT1);
            oEvent->vOLDLength.push_back(
                    getBlockIDX((int) (oPlayer->getXPos() + oPlayer->getHitBoxX() / 2 - fXPos)) * 32 + 7 * 32 +
                    (addOne ? 32 : 0));
            break;
    ...
    oEvent->vOLDDir.push_back((Event::animationType &&) oEvent->eMARIOSPRITE1);
    oEvent->vOLDLength.push_back(1);
    ...
    switch (currentLevelID) {
        case 31:
            oEvent->vOLDDir.push_back((Event::animationType &&) oEvent->eENDGAMEBOSSTEXT2);
            oEvent->vOLDLength.push_back(
                    getBlockIDX((int) (oPlayer->getXPos() + oPlayer->getHitBoxX() / 2 - fXPos)) * 32 + 5 * 32 +
                    (addOne ? 32 : 0) + 28);
            break;
        default:
            oEvent->vOLDDir.push_back((Event::animationType &&) oEvent->eBOSSTEXT2);
            oEvent->vOLDLength.push_back(
                    getBlockIDX((int) (oPlayer->getXPos() + oPlayer->getHitBoxX() / 2 - fXPos)) * 32 + 5 * 32 +
                    (addOne ? 32 : 0));
            break;
...
void Map::playerDeath(bool animation, bool instantDeath) {
    if ((oPlayer->getPowerLVL() == 0 && !oPlayer->getUnkillAble()) || instantDeath) {
        ...
        if (animation) {
            ...
            oEvent->vOLDDir.push_back((Event::animationType &&) oEvent->eDEATHNOTHING);
            oEvent->vOLDLength.push_back(30);

            oEvent->vOLDDir.push_back((Event::animationType &&) oEvent->eDEATHTOP);
            oEvent->vOLDLength.push_back(64);

            oEvent->vOLDDir.push_back((Event::animationType &&) oEvent->eDEATHBOT);
        ...
        if (oPlayer->getNumOfLives() > 1) {
            oEvent->vOLDDir.push_back((Event::animationType &&) oEvent->eLOADINGMENU);
            oEvent->vOLDLength.push_back(90);
            ...
            oEvent->vOLDDir.push_back((Event::animationType &&) oEvent->eGAMEOVER);
            oEvent->vOLDLength.push_back(90);
...
void Map::startLevelAnimation() {
    ...
    switch (currentLevelID) {
        ...
        case 1:
            ...
            oEvent->vOLDDir.push_back((Event::animationType &&) oEvent->ePLAYPIPERIGHT);
            oEvent->vOLDLength.push_back(1);
...
void Map::structGND(int X, int Y, int iWidth, int iHeight) {
    for (int i = 0; i < iWidth; i++) {
        for (int j = 0; j < iHeight; j++) {
            lMap[X + i][Y + j]->setBlockID(
                    iLevelType == 0 || iLevelType == 4 ? 1 : iLevelType == 1 ? 26 : iLevelType == 2 ? 92 : iLevelType ==
                                                                                                           6 ? 166 :
                                                                                                           iLevelType ==
                                                                                                           7 ? 181
                                                                                                             : 75);
        ...
        for (int i = 0, k = 1; i < iSize; i++) {
            for (int j = 0; j < k; j++) {
                lMap[X + iSize - 1 - i][Y + j]->setBlockID(
                        iLevelType == 0 || iLevelType == 4 ? 25 : iLevelType == 3 ? 167 : 27);
            }
            ++k;
        }
    }
...
void Map::structPipe(int X, int Y, int iHeight) {
    for (int i = 0; i < iHeight; i++) {
        lMap[X][Y + i]->setBlockID(
                iLevelType == 0 ? 20 : iLevelType == 2 ? 97 : iLevelType == 4 ? 112 : iLevelType == 5 ? 136 :
                                                                                      iLevelType == 3 ? 176 :
                                                                                      iLevelType == 7 ? 172 : 30);
        lMap[X + 1][Y + i]->setBlockID(
                iLevelType == 0 ? 22 : iLevelType == 2 ? 99 : iLevelType == 4 ? 114 : iLevelType == 5 ? 138 :
                                                                                      iLevelType == 3 ? 178 :
                                                                                      iLevelType == 7 ? 174 : 32);
    }

    lMap[X][Y + iHeight]->setBlockID(
            iLevelType == 0 ? 21 : iLevelType == 2 ? 98 : iLevelType == 4 ? 113 : iLevelType == 5 ? 137 : iLevelType ==
                                                                                                          3 ? 177 :
                                                                                                          iLevelType ==
                                                                                                          7 ? 173 : 31);
    lMap[X + 1][Y + iHeight]->setBlockID(
            iLevelType == 0 ? 23 : iLevelType == 2 ? 100 : iLevelType == 4 ? 115 : iLevelType == 5 ? 139 : iLevelType ==
                                                                                                           3 ? 179 :
                                                                                                           iLevelType ==
                                                                                                           7 ? 175
                                                                                                             : 33);
...
void Map::structCoins(int X, int Y, int iWidth, int iHeight) {
    for (int i = 0; i < iWidth; i++) {
        for (int j = 0; j < iHeight; j++) {
            lMap[X + i][Y + j]->setBlockID(
                    iLevelType == 0 || iLevelType == 4 ? 71 : iLevelType == 1 ? 29 : iLevelType == 2 ? 73 : 29);
        }
    }
}
